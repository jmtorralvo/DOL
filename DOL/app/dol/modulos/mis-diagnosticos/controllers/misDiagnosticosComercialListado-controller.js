        ...
        function($scope, diagnosticos, MisDiagnosticosListadoSrv, $state, $modal, situacionComercial, motivoRechazo, rutaBaseTemplates, i18n, NgGridPluginsSrv, $filter, $upload, urlSubidaArchivos, urlDescargaArchivos, rutaBaseServicios) {
            ...
            $scope.tablaDiagnosticosComercial = {
                ...
                columnDefs: [{
                    ...
                    visible: $scope.user.userInfo.perfilUsuario === 'USR-06' || $scope.user.userInfo.perfilUsuario === 'USR-07' || $scope.user.userInfo.perfilUsuario === 'USR-05' || $scope.user.userInfo.perfilUsuario === 'USR-04' || $scope.user.userInfo.perfilUsuario === 'USR-03',
                    ...
                    visible: $scope.user.userInfo.perfilUsuario === 'USR-07' || $scope.user.userInfo.perfilUsuario === 'USR-05' || $scope.user.userInfo.perfilUsuario === 'USR-04' || $scope.user.userInfo.perfilUsuario === 'USR-03',
                    ...
                    visible: $scope.user.userInfo.perfilUsuario === 'USR-07' || $scope.user.userInfo.perfilUsuario === 'USR-04' || $scope.user.userInfo.perfilUsuario === 'USR-03',
                    headerCellTemplate: headerWithFilter
                }, {
                    field: 'delegadoComercial.tx_nombre',
                    displayName: i18n.COMERCIAL_DELEGADO_COMERCIAL,
                    visible: $scope.user.userInfo.perfilUsuario === 'USR-07' || $scope.user.userInfo.perfilUsuario === 'USR-03',
                    headerCellTemplate: headerWithFilter
                }, {
                    field: 'documentacion',
