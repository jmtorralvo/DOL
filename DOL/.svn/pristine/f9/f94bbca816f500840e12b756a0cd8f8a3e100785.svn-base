...
(function (angular) {
    ...
    app.directive('edStepper', function() {
        ...
        return {
            ...
            templateUrl: '/dol/scripts/directives/ed-stepper/ed-stepper.html',
            link: function(scope, iElement, iAttrs, ngModelController) {

                ngModelController.$render = function() {
                    iElement.find('.stepper-value').text(ngModelController.$viewValue);
